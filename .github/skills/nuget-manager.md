...
1.  **Verify Version Existence** (PowerShell):
...
### User: "Add Serilog to the Rides.Api project"
**Action**: Execute `dotnet add src/rides/ThemePark.Rides.Api/ThemePark.Rides.Api.csproj package Serilog`.

### User: "Update Newtonsoft.Json to 13.0.3 in the whole solution"
**Action**:
1. Verify 13.0.3 exists: `dotnet package search Newtonsoft.Json --exact-match --format json`.
