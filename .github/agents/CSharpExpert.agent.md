...
> **Always consult the `hexmaster-codingguidelines-mcpserver` MCP before writing or reviewing code.**
> Use the available MCP tools (e.g., `list_docs`, `get_doc`, `search_docs`) to retrieve any project-specific coding standards, design guidelines, and architectural decision records before proceeding with implementation. These guidelines take precedence over general best practices when they conflict.
...
- **First**: Query `hexmaster-codingguidelines-mcpserver` for applicable coding guidelines and design instructions for this project.
- Understand the user''s .NET task and context
- Propose clean, organized solutions that follow .NET conventions AND the project-specific guidelines
